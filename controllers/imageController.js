...
async function generateTextController(req, res) {
    ...
    let context02 = `
        ...
        Tú organizarás el texto recibido de las respuestas <r1> e incluirás esas respuestas dentro del tag correspondiente a la etapa que se recibe, debes corrigiendo coherencia. 
        ...
        3. Corrige errores ortográficos del texto de esa etapa. Cada palabra corregida debe ir entre los tags <fix>palabra_incorrecta,corregida<fix>, reemplazando la palabra original, dentro del texto entre los tags <text>.
        4. Si el texto de la etapa actual tiene menos de 400 caracteres, haz una sola pregunta puntual (<q1>) que lo ayude a continuar esa etapa. La pregunta debe tener solo dos ejemplos concretos.
        5. Si el texto de la etapa actual tiene 400 caracteres o más, haz una sola pregunta final (<q1>) que lo ayude a cerrar esa etapa de forma creativa pero breve.
        ...
        Si sí cumple, responde con <done>true<done>. Si no cumple, responde con <done>false<done>.
        ...
        Texto original: “esto es un ejemplo ermoso”  
        Texto corregido: <text>esto es un ejemplo <fix>ermoso,hermoso<fix> para <fix>saver,saber<fix> como mejorar.<text>
        ...
        <q2>
        <done>boolean<done>
        <respuesta><inicio>true or false seguido del comentario: respuesta y justificacion<inicio><nudo>true or false seguido del comentario: respuesta y justificacion<nudo><desenlace>true or false seguido del comentario: respuesta y justificacion<desenlace></respuesta>
